...
word_model_bp = Blueprint('word_model', __name__)
...
# Define class names
class_names = ['A-Correct', 'A-Incorrect', 'Ga-Correct', 'Ga-Incorrect', 'Ha-Correct', 'Ha-Incorrect', 'IE-Correct', 'IE-Incorrect', 'Ka-Correct', 'Ka-Incorrect']


# Define normalization layer
normalization_layer = tf.keras.layers.Rescaling(1./255)

@word_model_bp.route('/predict', methods=['POST'])
def predict():
    try:
        print("Word")
