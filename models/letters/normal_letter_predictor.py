...
normal_letter_model_bp = Blueprint('normal_letter_model', __name__)
...
# Load the model
model_path = os.path.join(os.path.dirname(__file__), 'normal_letters.h5')
...
@normal_letter_model_bp.route('/predict', methods=['POST'])
def predict():
    try:
