...
dotted_letter_model_bp = Blueprint('dotted_letter_model', __name__)
...
# Load the model
model_path = os.path.join(os.path.dirname(__file__), 'dotted_letters.h5')
...
class_names = [
    ...
    'Ha-correct', 'Ha-incorrect', 
    'IE-correct', 'IE-incorrect', 
    'Ka-correct', 'Ka-incorrect'
]

# Define normalization layer
normalization_layer = tf.keras.layers.Rescaling(1./255)

@dotted_letter_model_bp.route('/predict', methods=['POST'])
def predict():
    try:
        print("Dotted Letters")
